...
W9 = weight_variable( [100,100] )
b9 = bias_variable( [100] )
A9 = tf.nn.relu(tf.matmul(A8, W9) + b9)
W10 = weight_variable( [100,100] )
b10 = bias_variable( [100] )
A10 = tf.nn.relu(tf.matmul(A9, W10) + b10)
W11 = weight_variable( [100,1] )
b11 = bias_variable( [1] )
...
with tf.Session() as sess:
  ...
  with open('models/layer10_100/signal.csv', 'w') as f:
  ...
  with open('models/layer10_100/background.csv', 'w') as f:
    writer = csv.writer(f, delimiter=" ")
    for i in range(len(valid_data)):
