...
W10 = weight_variable( [100,1] )
b10 = bias_variable( [1] )
y = tf.matmul(A9,W10) + b10
##################
...
with tf.Session() as sess:
  ...
  with open('models/layer9_100/signal.csv', 'w') as f:
  ...
  with open('models/layer9_100/background.csv', 'w') as f:
    writer = csv.writer(f, delimiter=" ")
    for i in range(len(valid_data)):
