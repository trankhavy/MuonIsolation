...
W8 = weight_variable( [100,1] )
b8 = bias_variable( [1] )
y = tf.matmul(A7,W8) + b8
##################
...
with tf.Session() as sess:
  ...
  with open('models/layer7_100/signal.csv', 'w') as f:
  ...
  with open('models/layer7_100/background.csv', 'w') as f:
    writer = csv.writer(f, delimiter=" ")
    for i in range(len(valid_data)):
