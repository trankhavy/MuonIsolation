...
W7 = weight_variable( [100,1] )
b7 = bias_variable( [1] )
y = tf.matmul(A6,W7) + b7
##################
...
with tf.Session() as sess:
  ...
  with open('models/layer6_100/signal.csv', 'w') as f:
  ...
  with open('models/layer6_100/background.csv', 'w') as f:
    writer = csv.writer(f, delimiter=" ")
    for i in range(len(valid_data)):
